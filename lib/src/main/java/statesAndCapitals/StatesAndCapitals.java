...
public class StatesAndCapitals
{
    ...
    public void testStatesAndCapitals() throws IOException
    {
        ...
        Double averageYearlyPrecipitationAcrossStateCapitals = states.stream()
                .collect(Collectors.averagingDouble(state -> state.getCapital().getAverageYearlyPrecipitationInInches()));
        ...
        // CHATGPT HELPED WITH .flatmap to flatten the list of time zones
        Map<String, Long> numberOfStatesByTimeZone = states.stream()
                .collect(Collectors.groupingBy(state -> Arrays.toString(state.getTimeZones().toArray()), Collectors.counting()));
        ...
        Map<String, Long> numberOfStateCapitalsByTimeZone = states.stream()
                .collect(Collectors.groupingBy(state -> state.getCapital().getTimeZone(), Collectors.counting()));
